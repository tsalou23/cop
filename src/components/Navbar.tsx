...
const Navbar = () => {
  return (
    <nav 
      className="fixed w-full bg-charcoal/80 backdrop-blur-sm border-b border-copper/20"
      style={{
        zIndex: 1000, // Higher than sand effect
        top: 0,
        left: 0,
        right: 0
      }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <span className="font-orbitron text-copper text-xl font-bold copper-glow">
              COPPER SKY
            </span>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <button 
              className="wasteland-button flex items-center space-x-2 px-4 py-2 bg-copper/20 hover:bg-copper/30 rounded-md transition-colors"
            >
              <Wallet2 size={20} className="text-desert-sand" />
              <span className="text-desert-sand">Connect</span>
            </button>
            <a href="#" className="text-desert-sand hover:text-copper">
              <Twitter size={20} />
            </a>
            <a href="#" className="text-desert-sand hover:text-copper">
              <Discord size={20} />
